    ...
    <>
      <header className="header">
        {/* <div className='pre_head' onClick={handleGitHubLinkClick} style={{ cursor: 'pointer' }}>
          ...
          <div>
            <a style={{ textDecoration: 'none', color: 'white', fontWeight: "900" }} target='_blank' href='https://github.com/SuperDuperDB/superduperdb' className='pre_head_text'><span >SuperDuperDB is open-source! Find us on GitHub! </span> 🔮</a></div>
